      ...
      >
        ...
        >
          ...
          <motion.a
            ...
            className="inline-flex items-center justify-center space-x-3 bg-navy-blue text-white py-6 px-12 rounded-xl text-2xl font-semibold hover:bg-navy-blue/90 transition-all duration-300 hover:scale-105 hover:shadow-lg transform-gpu mb-6"
